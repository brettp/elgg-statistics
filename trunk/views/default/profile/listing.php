<?php
	 ...
	 */
		...
		if (!$banned) {
			...
			if(get_context() == 'site_message_user_list' && isadminloggedin()) {
				
				$message_count = get_entities_from_metadata('fromId',$vars['entity']->getGUID(),'object','messages', $vars['entity']->getGUID(), 0, 0, '', 0, true);
				
				$info .= "<p class=\"message_count\">" . $message_count . "</p>";
			}
